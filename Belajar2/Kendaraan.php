...
class Mobil extends Produk
{
    ...
    {
        $str = "Mobil : " . parent::infoProduk() . ", Kapasitas : {$this->isi_penumpang} Orang";
        return $str;
    }
}
...
class Truk extends Produk
{
    ...
    public function getInfoUnit()
    {
        ...
        $str = "Truk : " . parent::infoProduk() . ", Maks. Muatan : {$this->maksimal_muatan} Kg";
        return $str;
    }
}
...
//     {
//         $str = "{$Produk->nama_unit} | {$Produk->warna_unit}, {$Produk->infoProduk()}, Harga = Rp.{($Produk->harga_unit)}";
//         return $str;
//     }
// }
...
echo $owner1->getInfoUnit();
echo "<br>";
echo $owner2->getInfoUnit();

echo "<hr>";

$owner2->setDiskon(50);
echo $owner2->getHargaUnit();

echo "<hr>";

$owner1->setNamaUnit("Barang Baru");
echo $owner1->getNamaUnit();
